...
**linkedin** [**linkedin**](https://www.linkedin.com/in/sumonmia77/)  | **github** [**github**](https://github.com/Sumonmia)
...
* Biometric Security, Threat Intelligence & Pattern Recognition
...
### Human Emotion Recognition & Feature Fusion System (Undergraduate Research)
* Developed an end-to-end framework combining Histogram of Oriented Gradients (HOG), Local Binary Patterns (LBP), and Gabor Filters for optimized spatial, textural, and multi-scale frequency feature extraction.
* Implemented customized Artificial Neural Network (ANN) architectures to classify facial micro-expressions, achieving high validation accuracy on benchmark datasets.
* Optimized image preprocessing pipelines through facial region segmentation to accelerate neural network training speeds.
